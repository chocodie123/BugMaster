...
void AMageCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMageCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMageCharacter::Look);

		// Bugging
		EnhancedInputComponent->BindAction(BugAction,ETriggerEvent::Started, this, &AMageCharacter::Bug);
	}
	else
	{
...
void AMageCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
